...
echo -e "$red 1. HiddenEye $red(30 Phising Web)"
echo -e "$green ____________________________________________"
echo -e "$white 2. Hacktronian $red(All In One Linux Tool)"
echo -e "$green ____________________________________________"
echo -e "$cyan 3. Recondogs $red( 10 Tool Scaning Web )"
echo -e "$green ____________________________________________"
echo -e "$purple 4. MITMF $red( Spoofing Tools )"
echo -e "$green ____________________________________________"
echo -e "$yellow 5. HakkuFramework $red( 24 Penetration Tools )"
echo -e "$green ____________________________________________"
echo -e "$blue 6. ReconCobra $red(80 Tool Information Gathering)"
echo -e "$green ____________________________________________"
echo -e "$white 7. Wireshark $red( Sniffing Tools )"
echo -e "$green ____________________________________________"
echo -e "$red 8. SigPloit $red( Provider Attack )"
echo -e "$green ____________________________________________"
echo -e "$blue 9. Social Engineering Toolkit"
echo -e "$green ____________________________________________"
echo -e "$yellow 10. Metasploit $red( Penetration Tools )"
echo -e "$green ____________________________________________"
echo -e "$blue 11. Th3Inspector $red( Information Gathering )"
echo -e "$green ____________________________________________"
echo -e "$white 12. Fluxion $red( Hack Wifi )"
echo -e "$green ____________________________________________"
echo -e "$red 13. Wifiphisher ( Hack Wifi Evil Twin )"
echo -e "$green ____________________________________________"
echo -e "$blue 14. Wifite $red( Hack Wifi )"
echo -e "$green ____________________________________________"
echo -e "$purple 15. Cam-Hackers $red( Hack CCTV 91 Negara )"
echo -e "$green ____________________________________________"
